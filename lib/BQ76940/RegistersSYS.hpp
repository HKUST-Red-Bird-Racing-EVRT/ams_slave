...
extern Register SYS_STAT = Register(static_cast<uint8_t>(RegisterAddress::SYS_STAT), 0x00);
...
extern Register SYS_CTRL1 = Register(static_cast<uint8_t>(RegisterAddress::SYS_CTRL1), 0x00);
