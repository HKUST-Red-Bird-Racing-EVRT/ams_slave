...
extern Register ADCGAIN1 = Register(RegisterAddress::ADCGAIN1, 0x00);
extern Register ADCOFFSET = Register(RegisterAddress::ADCOFFSET, 0x00);
extern Register ADCGAIN2 = Register(RegisterAddress::ADCGAIN2, 0x00);
